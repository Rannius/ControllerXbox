...
function BadgeSizeSettings({ initial, save }) {
    ...
    return SP_JSX.jsxs(SP_JSX.Fragment, { children: [SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx(DFL.SliderField, { label: "K\u00F6nyvt\u00E1r ikonm\u00E9rete", value: draft.library_badge_percent, min: 50, max: 200, step: 5, resetValue: 100, showValue: true, valueSuffix: "%", disabled: working, onChange: value => setDraft({ ...draft, library_badge_percent: Math.round(value) }) }) }), SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx(DFL.SliderField, { label: "\u00C1ruh\u00E1z ikonm\u00E9rete", value: draft.store_badge_percent, min: 50, max: 200, step: 5, resetValue: 100, showValue: true, valueSuffix: "%", disabled: working, onChange: value => setDraft({ ...draft, store_badge_percent: Math.round(value) }) }) }), SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx(DFL.ButtonItem, { layout: "below", disabled: working || !dirty, onClick: async () => {
                    ...
                    }, children: working ? "Méret mentése…" : "Ikonméretek alkalmazása" }) }), SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx("div", { style: { fontSize: "12px", opacity: .8 }, children: error || "100% = eredeti méret. Könyvtár és áruház külön állítható." }) })] });
}
...
const getConnection = callable("get_price_connection");
const setConnection = callable("set_price_connection");
const testServer = callable("test_price_server");
...
function AllKeyShopSettings({ openMerchants }) {
    ...
    const [connection, setConnectionState] = SP_REACT.useState();
    const [serverToken, setServerToken] = SP_REACT.useState("");
    const [busy, setBusy] = SP_REACT.useState(false);
    ...
    SP_REACT.useEffect(() => {
        ...
        void Promise.all([timed(getPreferences()), timed(getConnection())]).then(([value, transport]) => {
            if (active) {
                if (!value.success || !transport.success)
                    throw new Error(value.error || transport.error || "Betöltési hiba");
                setPrefs(value);
    ...
    return SP_JSX.jsxs(SP_JSX.Fragment, { children: [SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx("div", { style: { marginTop: "12px", fontWeight: 700 }, children: "Kapcsolat" }) }), prefs && connection && SP_JSX.jsxs(SP_JSX.Fragment, { children: [SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx(DFL.ToggleField, { label: "Lek\u00E9r\u00E9s saj\u00E1t szerveren kereszt\u00FCl", checked: connection.mode === "server", disabled: busy, onChange: server => setConnectionState({ ...connection, mode: server ? "server" : "direct" }) }) }), connection.mode === "server" && SP_JSX.jsxs(SP_JSX.Fragment, { children: [SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx(DFL.TextField, { label: "Szerver HTTPS c\u00EDme", value: connection.url, disabled: busy, onChange: event => setConnectionState({ ...connection, url: event.currentTarget.value }) }) }), SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx(DFL.TextField, { label: connection.token_configured ? "Szervertoken (mentve; üresen megtartja)" : "Szervertoken", bIsPassword: true, value: serverToken, disabled: busy, onChange: event => setServerToken(event.currentTarget.value) }) }), SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx("div", { style: { fontSize: "12px" }, children: "A szervertokent az Ubuntu telep\u00EDt\u0151je adja. A GG.deals-kulcs szerveres m\u00F3dban az Ubuntun sz\u00FCks\u00E9ges." }) })] }), SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx("div", { style: { marginTop: "12px", fontWeight: 700 }, children: "\u00C1rforr\u00E1s" }) }), SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx(DFL.ToggleField, { label: "\u00C1rforr\u00E1s: GG.deals", description: "Kikapcsolva: AllKeyShop. V\u00E1lt\u00E1s az Alkalmaz\u00E1s gombbal.", checked: prefs.provider === "gg", disabled: busy, onChange: gg => setPrefs({ ...prefs, provider: gg ? "gg" : "aks" }) }) }), SP_JSX.jsxs(SP_JSX.Fragment, { children: [connection.mode === "direct" && SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx(DFL.TextField, { label: prefs.gg_key_configured ? "GG.deals API-kulcs (mentve; üresen megtartja)" : "GG.deals API-kulcs", bIsPassword: true, value: apiKey, disabled: busy, onChange: event => setApiKey(event.currentTarget.value) }) }), SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx("div", { style: { fontSize: "12px", lineHeight: 1.5 }, children: "GG.deals: EU/EUR ir\u00E1ny\u00E1r, boltra \u00E9s term\u00E9kt\u00EDpusra nem sz\u0171rhet\u0151. AKS-hib\u00E1n\u00E1l tartal\u00E9k forr\u00E1s, ha van API-kulcs." }) })] }), SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx("div", { style: { marginTop: "12px", fontWeight: 700 }, children: "Megjelen\u00EDt\u00E9s \u00E9s sz\u0171r\u00E9s" }) }), SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx(DFL.ToggleField, { label: "J\u00E1t\u00E9k\u00E1rak megjelen\u00EDt\u00E9se", checked: prefs.enabled, disabled: busy, onChange: async (enabled) => {
                                ...
                                try {
                                    ...
                                    if (!transport.success)
                                        throw new Error(transport.error || "Kapcsolati beállítás mentési hiba");
                                    setConnectionState(transport);
                                    setServerToken("");
                                    resetPriceView();
                            ...
                            }, children: busy ? "Mentés…" : "Árbeállítások alkalmazása" }) }), connection.mode === "server" && SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx(DFL.ButtonItem, { layout: "below", disabled: busy, onClick: async () => {
                                setBusy(true);
                                try {
                                    ...
                                    setMessage("A szerverkapcsolat nem ellenőrizhető.");
                                }
                                finally {
                                    setBusy(false);
                                }
                            }, children: "Mentett szerverkapcsolat tesztel\u00E9se" }) })] }), SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx("div", { style: { fontSize: "12px", opacity: .8 }, children: message || "EUR · Steam-kulcs és engedélyezett Gift; account kizárva. AKS: utoljára jelentett ár. Gyorsítótár: 24 óra." }) })] });
}
function AllKeyShopMerchants({ onBack }) {
    ...
    return SP_JSX.jsxs(SP_JSX.Fragment, { children: [SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx(DFL.ButtonItem, { layout: "below", onClick: onBack, children: "\u2190 Vissza" }) }), SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx("div", { style: { fontSize: "12px", lineHeight: 1.5 }, children: "Csak a bepip\u00E1lt boltok Steam-kulcs \u00E9s Gift aj\u00E1nlatai jelennek meg. A sz\u0171r\u00E9s a Decken t\u00F6rt\u00E9nik; \u00FCres lista eset\u00E9n nincs aj\u00E1nlat. Az \u00FAj boltokat k\u00FCl\u00F6n enged\u00E9lyezheted." }) }), SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx(DFL.TextField, { label: "Bolt keres\u00E9se", value: query, onChange: event => setQuery(event.currentTarget.value) }) }), SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx(DFL.ButtonItem, { layout: "below", disabled: busy, onClick: async () => {
                        setBusy(true);
                        try {
...
function readSteamEuroPrice(text) {
    ...
    if (separator < 0 || amount.length - separator !== 3)
        return null;
